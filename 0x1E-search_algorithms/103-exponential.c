...
/**
 * binary_search_index1 - Searches a value in a sorted array using a binary search.
...
/**
 * exponential_search - Searches a value in a sorted array using an exponential search.
 * @array: The array to search in.
